...
%
%  Move class vectors to define different problems then watch as a
%  learning vector quantization network takes single or multiple
%  learning steps toward properly classifying them.
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text v_axis t1_axis t2_axis,...
...
elseif strcmp(cmd,'setdot') & ~isempty(fig) & (nargin == 1)
