...
%
%  Select two network weight/bias parameters to train, their
%  initial values and learning rate, then watch as the network is
%  trained with steepest descent backpropagation. 
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text lr_bar lr_text cont_axis cont_ptr ...
