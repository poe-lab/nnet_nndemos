...
%
% Choose the number of neurons in a network and the complexity of a
% function to fit, and then watch the network's response improve as it
% is trained on the function.
%
...
elseif strcmp(cmd,'train') & ~isempty(fig) & (nargin == 1)
  ...
  Target = plot(P,T,'-','color',nnred,'linewidth',3,'CreateFcn','');
