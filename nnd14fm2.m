...
%
%  Repeatedly train a two-dimensional feature map so that its neurons
%  learn to classify different regions of a two-dimensional input space.
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  % NEW DEMO FIGURE
  fig = nndemof2(me,'DESIGN','2-D Feature Map','','Chapter 14');
...
elseif strcmp(cmd,'reset') & ~isempty(fig) & (nargin == 1)
