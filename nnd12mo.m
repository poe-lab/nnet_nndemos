...
%  initial values, and watch as the network is trained with momentum
%  backpropagation to find a minimum on the error surface. 
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text lr_bar lr_text mc_bar mc_text cont_axis cont_ptr ...
