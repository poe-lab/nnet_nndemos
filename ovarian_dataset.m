...
%   different patients.
%
%   ovarianTargets - a 2x216 matrix where each element indicates an
%   ovarian cancer patient with a [1;0], or a normal patient with a [0;1].
...
%
% For an intro to pattern recognition with the <a href="matlab:nprtool">Neural Pattern Recognition app</a>
...
%
% For an intro to clustering with the <a href="matlab:nctool">Neural Clustering app</a>
% click "Load Example Data Set" in the second panel and pick this dataset.
%
