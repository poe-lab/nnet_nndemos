...
%
% LOAD <a href="matlab:doc simpleseries_dataset">simpleseries_dataset</a>.MAT loads these two variables:
%
%   simpleseriesInputs - a 1x100 cell array of scalar values representing
...
%
% [X,T] = <a href="matlab:doc simpleseries_dataset">simpleseries_dataset</a> loads the inputs and targets into
...
% from only using past values of inputs. See <a href="matlab:doc narxnet">narxnet</a> for details.
%   
...
inputs = simpleseriesInputs;
targets = simpleseriesTargets;
