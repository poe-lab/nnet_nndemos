...
%
%  Define unit length input vectors then adjust the weight vectors
%  of three neurons and see how they classify the input vectors.
%
...
elseif strcmp(cmd,'up') & ~isempty(fig) & (nargin == 2)
...
elseif strcmp(cmd,'learn') & ~isempty(fig) & (nargin == 1)
...
elseif strcmp(cmd,'random') & ~isempty(fig) & (nargin == 1)
