...
%  initial values, and watch as the network is trained with variable
%  learning rate backpropagation to find a minimum on the error surface. 
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text lr_bar lr_text inc_bar inc_text ...
