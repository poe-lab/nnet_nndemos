...
%NND12M Marquardt-Levenberg Backpropagation
%
%  Select two network weight/bias parameters to train and their
%  initial values, and watch as the network is trained with Marquardt-
%  Levenberg backpropagation to find a minimum on the error surface. 
%
...
elseif strcmp(cmd,'init') & isempty(fig)
  ...
  H = nndArray({fig_axis desc_text mu_bar mu_text nu_bar nu_text cont_axis cont_ptr ...
